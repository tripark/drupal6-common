...
function tpc_profile_modules() {
  return array('help', 'menu', 'taxonomy', 'dblog', 'admin_menu', 'content', 'devel', 'filefield', 'imageapi', 'imageapi_gd', 'imagecache', 'imagecache_ui', 'imagefield', 'menu_block', 'path', 'pathauto', 'pathologic', 'php', 'search', 'text', 'textile', 'token', 'upload', 'vertical_tabs', 'views', 'views_ui', 'wysiwyg');
}
